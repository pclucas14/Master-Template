...
\subsection{Multi-Level Storage}\lable{sec:adap}
...
\paragraph{LiDAR} data can be very large and storage inefficient, it is also often collected by vehicles in potentially changing environments. Efficient storage can be improtant for having more representative data in downstream applications. Here we \mynotes{Lucas}. We show qualitatively several examples   
